...
namespace OurDestination.Controllers
{
    public class BloodGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BloodGroupId,BloodGroupName")] BloodGroup bloodGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BloodGroupId,BloodGroupName")] BloodGroup bloodGroup)
        {
            if (ModelState.IsValid)
            {
